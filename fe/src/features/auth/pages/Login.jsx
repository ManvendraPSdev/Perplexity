    ...
    <div className="min-h-screen flex items-center justify-center px-4"
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-white text-xl font-medium tracking-tight" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Perplexio
          </h1>
        </div>
        ...
        <div className="rounded-2xl p-8"
          ...
          <h2 className="text-white text-2xl font-medium mb-1">Welcome back</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-right -mt-2">
              <button type="button" className="text-xs transition-colors"
                style={{ color: "rgba(59,130,246,0.8)", background: "none", border: "none", cursor: "pointer" }}>
                Forgot password?
              </button>
            </div>
          ...
          <div className="relative my-5">
            ...
            <div className="relative text-center">
              <span className="px-3 text-xs" style={{ color: "rgba(255,255,255,0.25)", background: "transparent" }}>or</span>
            </div>
          </div>
